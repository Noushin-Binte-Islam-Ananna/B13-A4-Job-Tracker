...
mainContainer.addEventListener('click',function(event) {
    ...
    if(event.target.classList.contains('interview')){
        ...
        const jobHappen = interviewList.find(item => item.companyName == cardInfo.companyName)
        ...
        const jobHappen = rejectedList.find(item => item.companyName == cardInfo.companyName)
    ...
    for (let rejected of rejectedList) {
        ...
        <div class="flex justify-between">
                    ...
                    <div class="flex-1">
                        <!-- Header -->
                        <div>
                            <p class="companyName text-lg font-bold text-gray-900">${rejected.companyName}</p>
                            <p class="position text-lg font-semibold text-gray-500">${rejected.position}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <!-- Status Badge -->
                            <p class="status inline-block px-4 py-2 bg-gray-300 font-semibold rounded-md text-sm">${rejected.status}</p>
                            
                            <!-- Description -->
                            <p class="description text-gray-700 mt-3 mb-5">${rejected.description}</p>
                        </div> 
